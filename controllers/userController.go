	...
	return func(c *gin.Context) {
		...
		projectStage := bson.D{
			{"$project", bson.D{
				{"_id", 0},
				{"total_count", 1},
				{"user_items", bson.D{{"$slice", []interface{}{"$data"}}}},
			},
			},
		}
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if count > 0 {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "This email or phone number has already taken"})
			return
		}
...
func VerifyPassword(userPassword string, providedPassword string) (bool, string) {
	...
	if err != nil {
		msg = fmt.Sprintf("Login information or password is incorrect")
		check = false
	}
	return check, msg
}
